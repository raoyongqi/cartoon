...
public class MainActivity extends AppCompatActivity {
    ...
    private TensorImage loadImage(final Bitmap bitmap) {
        // Convert the bitmap to ARGB_8888 if it is not already in that format.
        Bitmap argbBitmap = bitmap.copy(Bitmap.Config.ARGB_8888, true);

        // Loads bitmap into a TensorImage.
        inputImageBuffer.load(argbBitmap);

        // Creates processor for the TensorImage.
        int cropSize = Math.min(argbBitmap.getWidth(), argbBitmap.getHeight());
